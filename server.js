        ...
        switch (data.type) 
        {
            ...
            case 'offer':
                ...
                if (users[data.otherUsername] != null) 
                {
                    ...
                    sendTo(users[data.otherUsername], {type: 'offer', offer: data.offer, username: ws.username})
                }
            break
            ...
            case 'answer':
                ...
                {
                    ws.otherUsername = data.otherUsername
                    sendTo(users[data.otherUsername], {type: 'answer', answer: data.answer})
                }
            break
            ...
            case 'candidate':
                ...
                if (users[data.otherUsername] != null) 
                    sendTo(users[data.otherUsername], {type: 'candidate', candidate: data.candidate})
            break
